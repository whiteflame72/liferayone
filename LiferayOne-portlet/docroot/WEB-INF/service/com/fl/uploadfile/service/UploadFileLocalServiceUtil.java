...
/**
 * The utility for the upload file local service. This utility wraps {@link com.fl.uploadfile.service.impl.UploadFileLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class UploadFileLocalServiceUtil {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteUploadFile(long fileUploadId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteUploadFile(fileUploadId);
	}
	...
	*/
	public static void deleteUploadFile(
		com.fl.uploadfile.model.UploadFile uploadFile)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteUploadFile(uploadFile);
	}
	...
	*/
	public static com.fl.uploadfile.model.UploadFile updateUploadFile(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateUploadFile(uploadFile, merge);
	}
	...
	public static UploadFileLocalService getService() {
		if (_service == null) {
			...
			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					UploadFileLocalService.class.getName(), portletClassLoader);
