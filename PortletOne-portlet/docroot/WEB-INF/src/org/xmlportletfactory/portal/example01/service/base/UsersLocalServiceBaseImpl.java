...
import org.xmlportletfactory.portal.example01.service.UsersLocalService;
import org.xmlportletfactory.portal.example01.service.persistence.UsersPersistence;
...
/**
 * The base implementation of the users local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.xmlportletfactory.portal.example01.service.impl.UsersLocalServiceImpl}.
 * </p>
 *
 * @author Jack A. Rider
 * @see org.xmlportletfactory.portal.example01.service.impl.UsersLocalServiceImpl
 * @see org.xmlportletfactory.portal.example01.service.UsersLocalServiceUtil
 * @generated
 */
public abstract class UsersLocalServiceBaseImpl implements UsersLocalService,
	IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.xmlportletfactory.portal.example01.service.UsersLocalServiceUtil} to access the users local service.
	 */
	...
	public Users addUsers(Users users) throws SystemException {
		...
		users = usersPersistence.update(users, false);
	 ...
	 */
	public Users createUsers(long usersId) {
		return usersPersistence.create(usersId);
	}
	...
	public void deleteUsers(long usersId)
		...
		Users users = usersPersistence.remove(usersId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(users);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteUsers(Users users) throws SystemException {
		usersPersistence.remove(users);
	...
	public Users fetchUsers(long usersId) throws SystemException {
		return usersPersistence.fetchByPrimaryKey(usersId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Users getUsers(long usersId) throws PortalException, SystemException {
		return usersPersistence.findByPrimaryKey(usersId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Users updateUsers(Users users, boolean merge)
		throws SystemException {
		users.setNew(false);

		users = usersPersistence.update(users, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.xmlportletfactory.portal.example01.model.Users",
			usersLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.xmlportletfactory.portal.example01.model.Users");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(UsersLocalServiceBaseImpl.class);
