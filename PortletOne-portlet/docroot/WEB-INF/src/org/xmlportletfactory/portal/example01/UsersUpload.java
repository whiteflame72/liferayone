...
/**
 * Upload implementation class Users
 */
public class UsersUpload {
	...
	public static String DOCUMENTLIBRARY_PORTLETFOLDER = "Users";
	public static String DOCUMENTLIBRARY_MAINFOLDER_DESCRIPTION = "XMLPortletFactory Portlet Document Uploads";
	public static String DOCUMENTLIBRARY_PORTLETFOLDER_DESCRIPTION = "Users Maintenance";
	...
	public Users uploadFiles(ActionRequest request,Users users) throws PortalException, SystemException, IOException, SecurityException, IllegalArgumentException, NoSuchMethodException, IllegalAccessException, InvocationTargetException{
	...
	private void callSetMethod(String formField, Users users, Long value) throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException{
		String strMethod = "set"+StringUtil.upperCaseFirstLetter(formField);
		Method methodSet = users.getClass().getMethod(strMethod,long.class);
		methodSet.invoke(users, value);
	}
