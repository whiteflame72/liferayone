...
public class UsersLocalServiceClp implements UsersLocalService {
	public UsersLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;

		_addUsersMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addUsers",
				org.xmlportletfactory.portal.example01.model.Users.class);

		_createUsersMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createUsers", long.class);

		_deleteUsersMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteUsers", long.class);

		_deleteUsersMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteUsers",
				org.xmlportletfactory.portal.example01.model.Users.class);
		...
		_fetchUsersMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
				"fetchUsers", long.class);

		_getUsersMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
				"getUsers", long.class);

		_getPersistedModelMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
				"getPersistedModel", java.io.Serializable.class);

		_getUsersesMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
				"getUserses", int.class, int.class);

		_getUsersesCountMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
				"getUsersesCount");

		_updateUsersMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateUsers",
				org.xmlportletfactory.portal.example01.model.Users.class);

		_updateUsersMethodKey14 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateUsers",
				org.xmlportletfactory.portal.example01.model.Users.class,
				boolean.class);
	...
	public org.xmlportletfactory.portal.example01.model.Users addUsers(
		...
		MethodHandler methodHandler = new MethodHandler(_addUsersMethodKey0,
		...
		return (org.xmlportletfactory.portal.example01.model.Users)ClpSerializer.translateOutput(returnObj);
	}
	...
	public org.xmlportletfactory.portal.example01.model.Users createUsers(
		...
		MethodHandler methodHandler = new MethodHandler(_createUsersMethodKey1,
				usersId);
	...
	public void deleteUsers(long usersId)
		...
		MethodHandler methodHandler = new MethodHandler(_deleteUsersMethodKey2,
				usersId);
	...
	public void deleteUsers(
		org.xmlportletfactory.portal.example01.model.Users users)
		throws com.liferay.portal.kernel.exception.SystemException {
		MethodHandler methodHandler = new MethodHandler(_deleteUsersMethodKey3,
				ClpSerializer.translateInput(users));
	...
	public org.xmlportletfactory.portal.example01.model.Users fetchUsers(
		...
		MethodHandler methodHandler = new MethodHandler(_fetchUsersMethodKey8,
				usersId);
	...
	public org.xmlportletfactory.portal.example01.model.Users getUsers(
		...
		MethodHandler methodHandler = new MethodHandler(_getUsersMethodKey9,
				usersId);
	...
	public java.util.List<org.xmlportletfactory.portal.example01.model.Users> getUserses(
		...
		MethodHandler methodHandler = new MethodHandler(_getUsersesMethodKey11,
				start, end);
		...
		return (java.util.List<org.xmlportletfactory.portal.example01.model.Users>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public int getUsersesCount()
		...
		MethodHandler methodHandler = new MethodHandler(_getUsersesCountMethodKey12);
	...
	public org.xmlportletfactory.portal.example01.model.Users updateUsers(
		...
		MethodHandler methodHandler = new MethodHandler(_updateUsersMethodKey13,
				ClpSerializer.translateInput(users));
	...
	public org.xmlportletfactory.portal.example01.model.Users updateUsers(
		...
		MethodHandler methodHandler = new MethodHandler(_updateUsersMethodKey14,
				ClpSerializer.translateInput(users), merge);
	...
	private MethodKey _addUsersMethodKey0;
	private MethodKey _createUsersMethodKey1;
	private MethodKey _deleteUsersMethodKey2;
	private MethodKey _deleteUsersMethodKey3;
	private MethodKey _dynamicQueryMethodKey4;
	private MethodKey _dynamicQueryMethodKey5;
	private MethodKey _dynamicQueryMethodKey6;
	private MethodKey _dynamicQueryCountMethodKey7;
	private MethodKey _fetchUsersMethodKey8;
	private MethodKey _getUsersMethodKey9;
	private MethodKey _getPersistedModelMethodKey10;
	private MethodKey _getUsersesMethodKey11;
	private MethodKey _getUsersesCountMethodKey12;
	private MethodKey _updateUsersMethodKey13;
	private MethodKey _updateUsersMethodKey14;
